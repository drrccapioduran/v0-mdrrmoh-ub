...
const Contacts = () => {
  ...
  const exportToCSV = () => {
    ...
    const rows = filteredContacts.map((c) => [c.name, c.agency, c.designation, c.phoneNumber, c.email, c.address || ""])
    ...
    <div className="min-h-screen flex flex-col" style={{ background: "linear-gradient(135deg, #70ffbc, #03966a)" }}>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <Button
                  variant="outline"
                  className="rounded-lg px-4 gap-2 border-[rgba(121,101,193,0.4)] bg-transparent"
                  style={{ color: "#E3D095" }}
                  onClick={exportToCSV}
                ...
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-lg border-[rgba(121,101,193,0.4)] bg-transparent"
                  style={{ color: "#E3D095" }}
                  onClick={() => refetch()}
                        ...
                        >
                          <td className="px-4 py-3">
                            <div className="flex items-center gap-3">
                              ...
                              <span className="font-semibold" style={{ color: "#E3D095" }}>
                                {contact.name}
                              </span>
                            </div>
                          </td>
                          <td className="px-4 py-3 hidden md:table-cell" style={{ color: "#E3D095" }}>
                            {contact.agency}
                          </td>
                          <td className="px-4 py-3 hidden lg:table-cell" style={{ color: "#E3D095" }}>
                            {contact.designation}
                          </td>
                          <td className="px-4 py-3">
                            <a
      ...
      <Dialog open={addModalOpen} onOpenChange={setAddModalOpen}>
        <DialogContent
          className="max-w-md"
          style={{
            background: "linear-gradient(to bottom, #001f10, #002e20)",
            border: "1px solid rgba(121, 101, 193, 0.4)",
          }}
        >
          <DialogHeader>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          data-testid="input-contact-agency"
                          className="bg-white/10 border-[rgba(121,101,193,0.4)] text-white"
                        />
                      </FormControl>
                      <FormMessage />
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          data-testid="input-edit-contact-agency"
                          className="bg-white/10 border-[rgba(121,101,193,0.4)] text-white"
                        />
                      </FormControl>
                      <FormMessage />
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          data-testid="input-edit-contact-designation"
                          className="bg-white/10 border-[rgba(121,101,193,0.4)] text-white"
                        />
                      </FormControl>
                      <FormMessage />
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        ...
        >
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() => {
                if (selectedIndex !== null) deleteMutation.mutate(selectedIndex)
              }}
