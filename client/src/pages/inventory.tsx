...
export default function Inventory() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#D8EFF7" }}>
      <BackgroundPattern />
                        ...
                        >
                          <td className="px-4 py-3">
                            <div>
                              ...
                              <p className="text-xs" style={{ color: "rgba(227, 208, 149, 0.6)" }}>
                                {item.itemDescription}
                              </p>
                            </div>
                          </td>
                          ...
                          <td className="px-4 py-3 text-center" style={{ color: "#E3D095" }}>
                            ...
                            <span className="text-xs ml-1" style={{ color: "rgba(227, 208, 149, 0.6)" }}>
                              {item.itemUnit}
                            </span>
                          </td>
