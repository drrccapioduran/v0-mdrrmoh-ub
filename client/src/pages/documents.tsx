...
function getFileTypeConfig(mimeType: string, fileName: string) {
  ...
  switch (extension) {
    case "docx":
      return fileTypeIcons["application/vnd.openxmlformats-officedocument.wordprocessingml.document"]
    case "doc":
      return fileTypeIcons["application/msword"]
    case "docm":
      return fileTypeIcons["application/vnd.ms-word.document.macroEnabled.12"]
    case "dotx":
      return fileTypeIcons["application/vnd.openxmlformats-officedocument.wordprocessingml.template"]
    case "dotm":
      return fileTypeIcons["application/vnd.ms-word.template.macroEnabled.12"]
    case "xlsx":
      return fileTypeIcons["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"]
    case "xls":
      return fileTypeIcons["application/vnd.ms-excel"]
    case "xlsm":
      return fileTypeIcons["application/vnd.ms-excel.sheet.macroEnabled.12"]
    case "xltx":
      return fileTypeIcons["application/vnd.openxmlformats-officedocument.spreadsheetml.template"]
    case "pptx":
      return fileTypeIcons["application/vnd.openxmlformats-officedocument.presentationml.presentation"]
    case "ppt":
      return fileTypeIcons["application/vnd.ms-powerpoint"]
    case "pptm":
      return fileTypeIcons["application/vnd.ms-powerpoint.presentation.macroEnabled.12"]
    case "potx":
      return fileTypeIcons["application/vnd.openxmlformats-officedocument.presentationml.template"]
    case "pdf":
...
function getDocumentType(mimeType: string, fileName: string): string {
  ...
  if (
    ...
    documentTypeGroups.word.extensions.some((ext) => lowerFileName.endsWith(ext))
  ) {
    return "word"
  }
  ...
  if (
    ...
    documentTypeGroups.excel.extensions.some((ext) => lowerFileName.endsWith(ext))
  ) {
    return "excel"
  }
  ...
  if (
    ...
    documentTypeGroups.powerpoint.extensions.some((ext) => lowerFileName.endsWith(ext))
  ) {
    return "powerpoint"
  }
  ...
  if (
    ...
    documentTypeGroups.text.extensions.some((ext) => lowerFileName.endsWith(ext))
  ) {
    return "text"
  }
...
function Documents() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "linear-gradient(135deg, #FFF8E1, #FFECB3)" }}>
      <BackgroundPattern />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              >
                <h3 className="font-semibold mb-4 flex items-center gap-2" style={{ color: "#5D4037" }}>
                  <Folder className="w-5 h-5" style={{ color: "#D68A3D" }} />
                  Folders
                </h3>
                ...
                {foldersLoading ? (
                  ...
                  <p className="text-sm text-center py-8" style={{ color: "rgba(93, 64, 55, 0.7)" }}>
              ...
              >
                {selectedFile ? (
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      <div
                        ...
                        style={{
                          background: getFileTypeConfig(selectedFile.mimeType || "", selectedFile.name || "").color,
                        }}
                      >
                        {getFileTypeConfig(selectedFile.mimeType || "", selectedFile.name || "").icon.slice(0, 4)}
                      </div>
                      <div className="flex-1">
                        ...
                        <p className="text-sm" style={{ color: "rgba(93, 64, 55, 0.7)" }}>
                    ...
                    >
                      <div>
                        <p className="text-xs mb-1" style={{ color: "rgba(93, 64, 55, 0.7)" }}>
                          Size
                        </p>
                  ...
                  <div>
                    <div className="mb-6">
                      <h3 className="text-xl font-bold mb-2 flex items-center gap-2" style={{ color: "#5D4037" }}>
                        <FolderOpen className="w-5 h-5" style={{ color: "#D68A3D" }} />
                        {selectedFolderName}
                      </h3>
                      <p className="text-sm" style={{ color: "rgba(93, 64, 55, 0.7)" }}>
                    ...
                    {filesLoading ? (
                      ...
                      <div className="space-y-8">
                        {Object.entries(documentTypeGroups).map(([type, group]) => {
                          ...
                          return (
                            <div key={type}>
                              <h4
                                ...
                                style={{ color: "#5D4037" }}
                              >
                                <div style={{ color: "#D68A3D" }}>{group.icon}</div>
                                {group.name}{" "}
                                <span className="text-sm font-normal opacity-75">({filesOfType.length})</span>
                              </h4>
                              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                                {filesOfType.map((file) => {
                                  const fileTypeConfig = getFileTypeConfig(file.mimeType || "", file.name || "")
                        ...
                        {groupedFiles.other && groupedFiles.other.length > 0 && (
                          <div>
                            <h4 className="text-lg font-bold mb-4 flex items-center gap-2" style={{ color: "#5D4037" }}>
                              <FileIcon className="w-5 h-5" style={{ color: "#D68A3D" }} />
                              Other Documents{" "}
                              <span className="text-sm font-normal opacity-75">({groupedFiles.other.length})</span>
                            </h4>
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
...
export { Documents, Documents as default }
