...
import { FileText, Folder, ChevronDown, ChevronRightIcon } from "lucide-react"
      ...
      <div className="flex items-center gap-1">
        ...
        <button
          ...
          className={`flex-1 flex items-center gap-2 py-2 px-2 rounded-lg transition-colors text-left ${
            selectedFolder === folder.id ? "bg-[#FFC9E]/50" : "hover:bg-white/50"
          }`}
          style={{ color: "#8B4513" }}
...
export default function Gallery() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "linear-gradient(135deg, #FFDFE0, #FFF6F7)" }}>
      <BackgroundPattern />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              ...
              >
                <h3 className="font-semibold mb-4 flex items-center gap-2" style={{ color: "#8B4513" }}>
                ...
                {foldersLoading ? (
                  ...
                  <p className="text-sm text-center py-8" style={{ color: "rgba(139, 69, 19, 0.7)" }}>
                    No album available
                  </p>
                ) : (
              ...
              <div className="lg:col-span-3">
                {!selectedFolder ? (
                  ...
                  <EmptyState
                    ...
                    description={searchQuery ? "Try adjusting your search." : "This photo album has no images yet."}
                  />
                ) : (
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {filteredImages.map((image, idx) => (
                      <div
                        ...
                        style={{
                          background: "linear-gradient(135deg, #FFF6F7, #FFDFE0)",
                          border: "1px solid #FEAE97",
                        }}
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{
                            background: "linear-gradient(to top, rgba(139, 69, 19, 0.8) 0%, transparent 50%)",
                          }}
                        >
